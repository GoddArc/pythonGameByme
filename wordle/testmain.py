...
row_group1.add(Rowr(upper_gap))
row_group2.add(Rowr(upper_gap+square_Size+gap))
row_group3.add(Rowr(upper_gap+2*(square_Size+gap)))
row_group4.add(Rowr(upper_gap+3*(square_Size+gap)))
row_group5.add(Rowr(upper_gap+4*(square_Size+gap)))
row_group6.add(Rowr(upper_gap+5*(square_Size+gap)))
chekc=True
word_guessed=''
word_guessed2=''
word_guessed3=''
